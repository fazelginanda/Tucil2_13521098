...
/* Mempartisi larik l[i..j] dengan cara mencari elemen minimum di dalam l[i..j] */
...
/* Proses : Mengurutkan l dengan salah satu algoritma selection sort berdasarkan ordinat */
void partisiY(ListPoint *l, int i, int j);
/* Mempartisi larik A[i..j] dengan cara mencari elemen minimum di dalam l[i..j] */
/* Menempatkan elemen terkecil sebagai elemen pertama larik */
/* Masukan: l[i..j] sudah terdefinisi elemen-elemennya */
/* Luaran: l[i..j] dengan l[i] adalah elemen minimum. */
